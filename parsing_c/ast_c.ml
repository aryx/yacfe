     ...
     and structType  = field list 
        and field = fieldbis wrap 
         and fieldbis = 
           ...
           | EmptyField (* gccext: *)
           | MacroStructDeclTodo
            (* cppext: CppDirectiveInStructure TODO *)
...
and expressionbis = 
  ...
  and argument = (expression, wierd_argument) either
   and wierd_argument = 
      ...
      and action_macro = 
        (* cppext: ArgStatement of statement, possibly have ghost token *)
         | ActMisc of il 
  ...
  | MacroDecl of (string * argument wrap2 list) wrap
     ...
     and initialiser = initialiserbis wrap
       and initialiserbis = 
          ...
          (* cppext: *)
          | IfdefInitializer of ifdef_directive (* * initializer list *)
