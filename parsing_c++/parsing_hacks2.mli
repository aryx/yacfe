...
type define_body = (unit,string list) either * Parser_cplusplus.token list

val _defs : (string, define_body) Hashtbl.t ref


val fix_tokens_define : Parser_cplusplus.token list -> Parser_cplusplus.token list
val extract_cpp_define : Parser_cplusplus.token list -> (string, define_body) assoc


val fix_tokens_cpp : Parser_cplusplus.token list -> Parser_cplusplus.token list

(* next stream tokens -> passed stream tokens -> final next token *)
val lookahead : Parser_cplusplus.token list -> Parser_cplusplus.token list -> Parser_cplusplus.token
