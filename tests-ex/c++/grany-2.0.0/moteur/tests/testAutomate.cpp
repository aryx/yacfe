...
int main()
{
  ...
  creeCellulePhase1(mon_automate,3);
  ...
  creeCellulePhase2(mon_automate,16);
  creeCelluleParoi(mon_automate);
  ...
  //timing(&mon_automate); 
  //mon_automate.afficheurReseau();
  //  mon_automate.afficheur();


  Automate* autom = new Automate(*mon_automate);
  delete mon_automate;

  

//  Automate* autom2 = new Automate(*autom);
//  delete autom;

  //  mon_automate->afficheur();
  //  cout << "ENDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD" << endl;
