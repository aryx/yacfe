 ...
 *  de préciser le comportement d'une cellule modélisant une portion
 *  de paroi ; en fait elle simule la présence en son sein d'une particule
...
public:
  ...
  /// Mise à jour de la couleur commune des cellules Paroi.
